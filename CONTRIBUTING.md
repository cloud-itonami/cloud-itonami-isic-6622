...
`cloud-itonami-isic-6622` accepts contributions to the OSS blueprint, capability
...
- Keep placing/binding a policy on the customer's behalf, or booking a commission behind the Insurance Intermediation Governor.
