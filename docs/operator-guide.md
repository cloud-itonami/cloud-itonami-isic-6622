...
3. Run read-only validation of existing records against this blueprint's
   contracts.
4. Configure the Insurance Intermediation Governor's hold/escalation policy.
5. Publish a dry-run operation and audit export.

## Minimum Production Controls

- spec-basis citation required before any customer-facing determination
- placing/binding a policy on the customer's behalf, or booking a commission always requires a human sign-off
